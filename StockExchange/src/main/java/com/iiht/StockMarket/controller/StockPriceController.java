...
public class StockPriceController {
	...
	public ResponseEntity<List<StockPriceDetailsDTO>> getStockByCompanyCode(@PathVariable Long companyCode) {
		List<StockPriceDetailsDTO> listStockPriceDetailsDTO=stockMarketService.getStockByCode(companyCode);
		return new ResponseEntity<List<StockPriceDetailsDTO>>(listStockPriceDetailsDTO,new HttpHeaders(),HttpStatus.OK);
	}
	//-------------------------------------------------------------------------------------------------------------------------------
	...
	public ResponseEntity<StockPriceIndexDTO> displayStockPriceIndex(@PathVariable Long companyCode, @PathVariable Date startDate, @PathVariable Date endDate) {
		StockPriceIndexDTO stockPriceIndexDTO=stockMarketService.getStockPriceIndex(companyCode,startDate.toLocalDate(),endDate.toLocalDate());
		return new ResponseEntity<StockPriceIndexDTO>(stockPriceIndexDTO,new HttpHeaders(),HttpStatus.OK);
	}
